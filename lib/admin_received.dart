...
class AdminReceived extends StatefulWidget {
  const AdminReceived({Key? key}) : super(key: key);

  @override
  _AdminReceivedState createState() => _AdminReceivedState();
}

class _AdminReceivedState extends State<AdminReceived> {
  List<dynamic> _data = [];
  ...
  Future<void> _fetchData() async {
    try {
      ...
      final response = await http.get(Uri.parse(
          "http://192.168.68.105/memo_api/get_admin_received.php?user_id=$userId"));
